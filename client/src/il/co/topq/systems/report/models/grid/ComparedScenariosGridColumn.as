package il.co.topq.systems.report.models.grid
{
	 ...
	 * @date July 29th, 2009
	 */
	public class ComparedScenariosGridColumn extends DataGridColumn
	{
		...
		public function ComparedScenariosGridColumn(columnName:String = null) {
			super(columnName);
			this.headerRenderer = new HeaderRenderer(this);
		}

		public function setScenarioID(scenarioID:String):void{
...
/**
 * This helper class is the renderer used by the above ComparedScenariosGridColumn.
...
internal class HeaderRenderer extends DataGridItemRenderer implements IFactory
{
	...
	private var column:ComparedScenariosGridColumn;
	private var fullText:String;
	
	public function HeaderRenderer(column:ComparedScenariosGridColumn) {
		this.column = column;
	}
