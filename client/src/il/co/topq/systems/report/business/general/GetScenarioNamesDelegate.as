package il.co.topq.systems.report.business.general
{
	...
	public class GetScenarioNamesDelegate implements  IResponder
	{
		    private var model: ReportModelLocator = ReportModelLocator.getInstance();
	
			private var responder:IResponder;
			
			public function GetScenarioNamesDelegate(){
				this.responder = this;
			}
			
			public function get() : void
			{  
				var service:HTTPService = ServiceLocator.getInstance().getHTTPService("getScenarioName");
			...
			public function result(data:Object): void
			{
				...
				model.scenarioName = new XML(evt.message.body);
			}
