package il.co.topq.systems.report.business.general
{
	...
	public class GetBuildDelegate implements  IResponder
	{
		    private var model: ReportModelLocator = ReportModelLocator.getInstance();
	
			private var responder:IResponder;
			
			public function GetBuildDelegate(){
				this.responder = this;
			}
			
			public function get() : void
			{  
				var service:HTTPService = ServiceLocator.getInstance().getHTTPService("getBuilds");
			...
			public function result(data:Object): void
			{
				...
				model.builds = new XML(evt.message.body);
			}
