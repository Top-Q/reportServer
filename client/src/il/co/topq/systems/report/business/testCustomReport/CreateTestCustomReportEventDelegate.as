package il.co.topq.systems.report.business.testCustomReport
{
	 ...
	 * @author Eran Golan
	 */
	public class CreateTestCustomReportEventDelegate
	{
		private var responder:IResponder;
		private var model:ReportModelLocator = ReportModelLocator.getInstance();
		
		public function CreateTestCustomReportEventDelegate(responder : IResponder)
		{
		...
		{  			
			var xm:XML = createXML();	//will get the xml build for the request;
			
			var service:HTTPService = 
				ServiceLocator.getInstance().getHTTPService("createTestCustomReport");
			service.request = xm;
		...
		private function createXML(): XML
		{
			...
			for (var i:int = 0; i < arr.length; i++){
				...
				xmlStr += (	
					"<" +nodeProperties+ " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"testProperty\">" 
						+ "<" +nodePropertyKey+ ">" 
