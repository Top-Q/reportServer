package il.co.topq.systems.report.context;
...
public class SecurityContextHandler {
	...
	public static void setUserContext(User user) {
		...
		Collection<GrantedAuthority> authorities = permissionsToGrantedAutorities(user.getPermissions());
	...
	private static Collection<GrantedAuthority> permissionsToGrantedAutorities(String permissions) {
